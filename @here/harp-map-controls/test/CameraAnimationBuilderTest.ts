...
describe("MapControls", function() {
    ...
    describe("CameraAnimationBuilder", function() {
        ...
        it("appends a control point with default time", function() {
        ...
        it("append a control point with specified time", function() {
        ...
        it("creates orbit options", function() {
            ...
            assert.equal(orbitOptions.controlPoints[1].heading, -135);
            assert.equal(orbitOptions.controlPoints[2].heading, -270);
            assert.equal(orbitOptions.controlPoints[3].heading, -405);
